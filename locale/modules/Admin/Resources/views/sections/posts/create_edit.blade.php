                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data"
                    ...
                    <label class="label-control">Product Type </label>
                     ...
                     <select name="type" class="form-control input-small">
                        ...
                        <option value="Leather" @if(isset($post_translate->type) && $post_translate->type == 'Leather') selected="" @endif>Leather</option>
                        <option value="Textial" @if(isset($post_translate->type) && $post_translate->type == 'Textial') selected="" @endif>Textial Dyes</option>
                        <option value="Paper" @if(isset($post_translate->type) && $post_translate->type == 'Paper') selected="" @endif>Paper Dyes</option>    
                                 
                     </select><br><br>

                      <label class="label-control">Color Code </label>

                     <input type="color" name="color" value="{{@ $post_translate->color}}" class="form-control input-small">

...
class PostController extends AdminController {
    ...
    public function getEditPost($id)
    {
        ...
        $users = User::all();
        return view('admin::sections.posts.create_edit', compact('post_type', 'post', 'categories', 'categories_ids', 'language_icon', 'language_available', 'language', 'current_lang', 'action', 'multiple_media', 'users', 'post_translate'));
    ...
    protected function processForm($request , $id = null )
    {
        ...
        $post->translateOrNew($locale)->type  = trim($request->get('type')) ;
        $post->translateOrNew($locale)->color  = trim($request->get('color')) ;
